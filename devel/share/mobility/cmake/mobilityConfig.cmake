...
if("TRUE" STREQUAL "TRUE")
  set(mobility_SOURCE_PREFIX /home/jschlindwein/Desktop/OLD UBUNTU FILES/CNM_TEAM_CODE/src/mobility)
  set(mobility_DEVEL_PREFIX /home/jschlindwein/Desktop/OLD UBUNTU FILES/CNM_TEAM_CODE/devel)
  set(mobility_INSTALL_PREFIX "")
  set(mobility_PREFIX ${mobility_DEVEL_PREFIX})
else()
  set(mobility_SOURCE_PREFIX "")
  set(mobility_DEVEL_PREFIX "")
  set(mobility_INSTALL_PREFIX /home/jschlindwein/Desktop/OLD UBUNTU FILES/CNM_TEAM_CODE/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mobility' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jschlindwein/Desktop/OLD UBUNTU FILES/CNM_TEAM_CODE/src/mobility/${idir}'.  Ask the maintainer 'NASA Swarmathon <swarmathon@cs.unm.edu>' to fix it.")
    endif()
...
set(depends "geometry_msgs;roscpp;sensor_msgs;std_msgs;random_numbers;tf")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${mobility_dep}_FOUND)
      find_package(${mobility_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${mobility_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
