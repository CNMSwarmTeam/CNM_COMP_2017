...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jschlindwein/Desktop/OLD UBUNTU FILES/CNM_TEAM_CODE/install/${idir}'.  Ask the maintainer 'matthew <matthew@todo.todo>' to fix it.")
    endif()
